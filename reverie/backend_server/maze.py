...
class Maze: 
  def __init__(self, maze_name): 
    ...
    meta_info = json.load(open(f"{env_matrix}/maze_meta_info.json" % self.maze_name))
    ...
    blocks_folder = f"{env_matrix}/special_blocks" % self.maze_name
    ...
    maze_folder = f"{env_matrix}/maze" % self.maze_name
    ...
    # Auto Detection
    self.collision_block_id = sorted(set(collision_maze_raw))[1]
